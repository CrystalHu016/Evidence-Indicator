...
def _fetch_single_query_cached(api_url: str, query: str, timeout_seconds: int, cache_version: str = "v7_highlighting_fixed") -> Tuple[Optional[Dict], Optional[str]]:
...
def call_single_query(api_url: str, query: str) -> Tuple[Optional[Dict], Optional[str]]:
    ...
    try:
        with st.spinner("🔄 処理中..."):
            ...
            return _fetch_single_query_cached(api_url, query, timeout_seconds, "v7_highlighting_fixed")
    except Exception as e:
        return None, str(e)
